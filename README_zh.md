...
#### Gradle
    ...
    implementation group: 'org.codeba', name: 'redis-keeper-core', version: '2025.1.1'

    implementation group: 'org.codeba', name: 'redis-keeper-support', version: '2025.1.1'

#### Sbt

    libraryDependencies += "org.codeba" % "redis-keeper-core" % "2025.1.1"
    
    libraryDependencies += "org.codeba" % "redis-keeper-support" % "2025.1.1"
